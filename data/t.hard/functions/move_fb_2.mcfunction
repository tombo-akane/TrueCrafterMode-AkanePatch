...
execute as @s store result entity @s power[0] double -0.01 run scoreboard players get @s Chuz_Calc
...
execute as @s at @s positioned ^ ^ ^0.1 run scoreboard players operation @s Chuz_Calc -= @e[tag=pos,limit=1,sort=nearest] Chuz_Calc
scoreboard players operation @s Chuz_Calc *= @s Chuz_Speed
execute as @s store result entity @s power[1] double -0.01 run scoreboard players get @s Chuz_Calc
...
execute as @s at @s positioned ^ ^ ^0.1 run scoreboard players operation @s Chuz_Calc -= @e[tag=pos,limit=1,sort=nearest] Chuz_Calc
scoreboard players operation @s Chuz_Calc *= @s Chuz_Speed
execute as @s store result entity @s power[2] double -0.01 run scoreboard players get @s Chuz_Calc
