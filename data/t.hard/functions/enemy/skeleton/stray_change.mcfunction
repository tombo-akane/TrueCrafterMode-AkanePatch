...
# フロスト
    execute if score $Random Chuz_Temporary matches 3..4 run summon minecraft:stray ~ ~ ~ {Silent:1b,CustomNameVisible:0b,DeathLootTable:"t.hard:custom/frost",Tags:["T.HardFrost","Chuz_NonVanillaMob","T.HardAlreadyInit"],CustomName:'{"text":"Frost"}',ArmorItems:[{id:"minecraft:ice",Count:1b,tag:{Enchantments:[{id:"minecraft:frost_walker",lvl:1s}]}},{},{},{id:"minecraft:player_head",Count:1b,tag:{ItemEvent:T.HardFrost,SkullOwner:{Id:[I;561528042,-498511967,-2046977493,1737959260],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMmIxYzU4YzNiMGJmZTA3Y2Y3OWMwMTc0MWQwYjkzM2ZmNmE3YTdlYzc1ZjY2YjZmNmNiNDk1MjRjMTZlNzhlZSJ9fX0="}]}}}}],ArmorDropChances:[0.085F,0.085F,0.085F,1.000F],ActiveEffects:[{Id:14b,Amplifier:0b,Duration:9999999,ShowParticles:0b},{Id:28b,Amplifier:0b,Duration:9999999,ShowParticles:0b}],Attributes:[{Name:"generic.attack_damage",Base:6}]}
# ガスト
